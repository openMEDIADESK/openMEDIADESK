...
<%
    ...
    try {
        MailWrapper.sendMail("mailgate.stumpner.net","franz@stumpner.net","franz@stumpner.net","HTTP500 Exception - SearchResultExpired",mailbody);
...
%>
<h1>Fehler: Das von ihnen aufgerufene Suchergebnis ist abgelaufen existiert nicht mehr</h1>
<h2>The Searchresult has expired</h2>

<p>
    Fahren Sie auf der <a href="/">Startseite</a> fort.
</p>
