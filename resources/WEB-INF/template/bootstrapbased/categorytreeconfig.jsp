...
<script type="text/javascript">
    ...
    <c:url value="/${lng}/categoryedit" var="newSubCatUrl">
        <c:param name="parentCat" value="${category.categoryId}"/>
    </c:url>
    ...
    var categoryTreeCfgNewSubCaption = "<spring:message code="category.createsubin" arguments="${category.catTitle}"/>";
    ...
    <c:if test="${createRootCat && category.categoryId>0}">
    categoryTreeCfgShowToolbarNewRootAndSub = true;
    </c:if>
    var categoryTreeCfgShowToolbarDelete = false;
    <c:if test="${mediaMenu.actionDeleteCat && category.categoryId>0}">
