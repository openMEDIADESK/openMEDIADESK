<%@ page import="com.stumpner.mediadesk.usermanagement.User,
    ...
    if (Config.isConfigured) {
        ...
        if (Config.redirectStartPage.startsWith("/index/")) {
            String lngUrl = "/index/";
            if (!locale.getLanguage().isEmpty()) {
                lngUrl = "/"+locale.getLanguage()+"/";
            }
            redirectUrl = redirectUrl.replaceFirst("/index/",lngUrl);
        ...
        if (request.getHeader("User-Agent")!=null) {
            ...
            //);
            request.setAttribute("forwardUrl",redirectUrl);
        
    } else {
        //response.sendRedirect("configure.jsp");
        request.setAttribute("forwardUrl","configure.jsp");
    }
