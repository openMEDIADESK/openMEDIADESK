        ...
        function ($parse, $rootScope) {
            return function (scope, element, attrs) {
                ...
                element.bind("dragstart", function (e) {
                    ...
                    //Neu Drop Effekt via attrs drop-effect: none, copy, copyLink, copyMove, link, linkMove, move, all
                    var dropEffect = attrs.dropEffect || "move";
        ...
        function ($parse, $rootScope) {
            return function (scope, element, attr) {
                ...
                function onDragOver(e) {
                    ...
                    //Sf: herausgenommen, wird vorher im Draggable Tag gesetzt
