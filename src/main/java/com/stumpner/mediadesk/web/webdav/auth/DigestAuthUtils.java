...
public class DigestAuthUtils {
    ...
    public static Map parseDigestRequest(String authHeader) {

        if (!authHeader.toUpperCase().startsWith("DIGEST "))
          return null;  // we only do DIGEST


        String section212response = authHeader.substring(7);
