 ...
 */
public class ImportFilesystemController extends ModelFormPageController {

    AutoImageAssigner autoImageAssigner = new AutoImageAssigner();

    public ImportFilesystemController() {

        this.setCommandClass(ImageImportFilesystemCommand.class);
    ...
    protected ModelAndView showForm(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, BindException e) throws Exception {
        ...
        ImageImportFilesystemCommand command = (ImageImportFilesystemCommand)e.getTarget();
    ...
    protected void onBind(HttpServletRequest httpServletRequest, Object o, BindException e) throws Exception {
        ...
        ImageImportFilesystemCommand command = (ImageImportFilesystemCommand)o;
    ...
    protected ModelAndView processFormSubmission(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, BindException e) throws Exception {
        ...
        if (httpServletRequest.getParameter("delete")!=null) {
            ...
            try {
                if (command.importFiles==null) {
                    ...
                    this.importImages(command.importFiles,user.getUserId(),autoImageAssigner.getAutoImportObject(httpServletRequest),command);
                }
        ...
        if (autoImageAssigner.getAutoImportObject(httpServletRequest)!=null && !e.hasErrors()) {
            autoImageAssigner.sendRedirectOfAutoImport(autoImageAssigner.getAutoImportObject(httpServletRequest),httpServletResponse);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        ...
        //File importPath = new File(Config.fileSystemImportPath);
        //File[] files = importPath.listFiles();
        ImageImportFilesystemCommand fileList = new ImageImportFilesystemCommand();
        /*
        for(int p=0;p<files.length;p++) {
    ...
    private void importImages(String[] imageFiles,int userId,Object autoImportObject, ImageImportFilesystemCommand command) throws SizeExceedException, MetadataReadException, MimeTypeNotSupportedException, FileRejectException {

        Logger logger = Logger.getLogger(ImportFilesystemController.class);
        int importFailure = 0;
        int ivid = 0;
    ...
    private void deleteFiles(String[] files, ImageImportFilesystemCommand command) {
